                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                            <a href="addUsers.php" style="color: white;">
                                        ...
                                        <tbody>
                                            <tr>
                                                 ...
                                                 <td>
                                                     <div class="table-data-feature">
                                                        <a href="EditUsers.php?id=<?php echo $d['id']?>">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </button>
                                                        </a>
                                                        <a href="deleteUsers.php?id=<?php echo $d['id']?>">
                                            ...
                                            ?>
                                              <?php if (ISSET($_POST['submit'])){
                                                $cari = $_POST['cari'];
                                                $query2 = "SELECT * FROM users WHERE nis LIKE '%$cari%'";
