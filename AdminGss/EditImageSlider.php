                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="ImageSlider.php">
                                <i class="fas fa-table"></i>ImageSlider</a>
                        </li>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="ImageSlider.php">
                            <i class="fas fa-table"></i>Image Slider</a>
                        </li>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Edit Data</strong> Image Slider
                                    </div>
                                    ...
                                    <?php
                                        include 'koneksi.php';
                                        $id = $_GET['id'];
                                        $data = mysqli_query($koneksi,"select * from image_slidder where id='$id'");
                                        while($d = mysqli_fetch_array($data)){
                                            ?>
                                        <form action="ProsesEditImageSlider.php" method="post" class="">
                                            ...
                                            <div class="form-group">
                                                <input type="text"  value="<?php echo $d['url'];?>" id="url" name="url" placeholder="Url" class="form-control">
                                            </div>
