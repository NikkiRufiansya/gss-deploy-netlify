                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Input Data</strong> Absensi
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="ProsesAddAbsen.php" method="post" class="">
                                     ...
                                     <?php
                                        ...
                                        ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <!-- <input type="text" id="semester" name="semester" placeholder="Semester" class="form-control">
                                                -->
                                                <select name="bulan" class="form-control" placeholder="semester">
                                                <option value="bukan">Bulan</option>
                                            ...
                                            <div class="form-group">
                                                <input type="text" id="jam" name="jam" placeholder="jam" class="form-control">
                                            </div>
                                            <div class="form-group">
                                            <span>Status Kehadiran : </span>
                                            <label class="radio-inline">
                                                <input type="radio" value="Masuk" name="status" > Masuk 
                                                </label> 
                                                <label class="radio-inline">
                                                <input type="radio" value="Izin" name="status"> Izin 
                                                </label>
                                                <label class="radio-inline">
                                                <input type="radio" value="Sakit" name="status"> Sakit 
                                                </label>
                                                <label class="radio-inline">
                                                <input type="radio" value="Alfa" name="status"> Alfa 
                                                </label>
                                            </div>
