<?php 
  ...
  if (empty($gambar)){
    mysqli_query( $koneksi,"UPDATE informasi SET nama = '$_POST[nama]',
                                                subjek = '$subjek',
                                            waktu = '$waktu',
                        			    image    = '$urlhasil',
                                        teks = '$_POST[teks]',
    ...
    if (move_uploaded_file($lokasi_file,"$folder")) {
    	...
    	$sql = "UPDATE informasi SET nama='$nama',subjek='$subjek' ,waktu='$waktu',image = '$urlhasil' , teks = '$teks',url = '$url1', file='$nama_file' WHERE id='$id'";
