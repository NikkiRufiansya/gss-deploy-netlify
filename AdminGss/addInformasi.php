                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Input Informasi</strong> Sekolah
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="ProsesAddInformasi.php" method="post" class="" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group"> 
                                            <textarea class="form-control" name="subjek"  maxlength="250" rows="5" id="comment" placeholder="Subjek "></textarea>             
                                            </div>
                                            <div class="form-group">
                                                <span>Tanggal</span>
                                                <input type="date" id="waktu"  name="tanggal" placeholder="waktu" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <span>Jam</span>
                                                <input type="time" id="waktu"  name="jam" placeholder="waktu" class="form-control">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <textarea name="teks" class="ckeditor"></textarea>
                                            </div>
