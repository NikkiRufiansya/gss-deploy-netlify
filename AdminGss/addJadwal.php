                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Input</strong> Jadwal
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="ProsesAddJadwal.php" method="post" class="">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <!-- <input type="text" id="semester" name="semester" placeholder="Semester" class="form-control">
                                                -->
                                                <select name="hari" class="form-control" placeholder="semester">
                                                <option value="tahun">Hari</option>
                                            ...
                                            <div class="form-group">
                                                <input type="text" id="nama_pelajaran" name="nama_pelajaran" placeholder="Mata Pelajaran" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" id="jam" name="jam" placeholder="jam" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" id="guru" name="guru" placeholder="Guru" class="form-control">
                                            </div>
