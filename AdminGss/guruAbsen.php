                         ...
                         <div class="row m-t-30">
                            <div class="col-md-12">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" name="cari" placeholder="Cari NIP " class="form-control">
                                     ...
                                     <table class="table table-borderless table-data3">
                                        ...
                                        <?php
                                         if(!ISSET($_POST['submit'])){
                                            include 'koneksi.php';
                                            $data = mysqli_query($koneksi,"SELECT * FROM `guruabsen`");
                                        ...
                                        <tbody>
                                            ...
                                            <?php if (ISSET($_POST['submit'])){
                                                $cari = $_POST['cari'];
                                                $query2 = "SELECT * FROM guruabsen WHERE nip LIKE '%$cari%'";
