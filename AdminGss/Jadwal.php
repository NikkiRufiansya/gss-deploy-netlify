                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                            <a href="addJadwal.php" style="color: white;">
                                ...
                                <form method="post">
                                <div class="input-group mb-3">
                                <select name="hari" class="form-control" placeholder="tahun">
                                ...
                                <select name="semester" class="form-control" placeholder="tahun">
                                    ...
                                    <div class="input-group-append">
                                        <input type="submit" name="submit_hari" value="cari" class="btn btn-outline-secondary">
                                    </div>
                                </div>
                                <form>
                                ...
                                <div class="scrollmenu">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                 ...
                                                 <td>
                                                     <div class="table-data-feature">
                                                        <a href="EditJadwal.php?id=<?php echo $d['id']?>">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </button>
                                                        </a>
                                                        <a href="deleteJadwal.php?id=<?php echo $d['id']?>">
                                             ...
                                             <?php if (ISSET($_POST['submit_hari'])){
                                                $hari = $_POST['hari'];
                                                $semester = $_POST['semester'];
                                                $query2 = "SELECT * FROM jadwal WHERE hari LIKE '%$hari%' AND semester LIKE '%$semester%'";
