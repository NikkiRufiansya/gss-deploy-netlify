...
<table align="center" cellpadding="0" cellspacing="0" width="100%" height="100%">
  <tr>
    ...
    <table cellspacing="0" cellpadding="0" width="100%">
      <tr>
        <td style="background:#cccccc" width="100%">

          <center>
            <table cellspacing="0" cellpadding="0" width="600" class="w320">
              <tr>
                <td valign="top" class="mobile-block mobile-no-padding-bottom mobile-center" width="270" style="background:#cccccc;padding:10px 10px 10px 20px;">
                  <a href="#" style="text-decoration:none;">
                    <img src="http://gitasoft.id/AdminGss/images/logo.png" width="142" height="45" alt="Your Logo"/>
                  </a>
                </td>
                <td valign="top" class="mobile-block mobile-center" width="270" style="background:#cccccc;padding:10px 15px 10px 10px">
            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px 20px 0">
                  ...
                  <h1>Gita Smart School</h1>

                  <br>
                  Gita Smart School adalah sistem informasi manajemen berbasis cloud yang hadir sebagai solusi untuk membantu mempermudah Sekolah dalam mengelola data siswa, guru, dan karyawan.<br><br>
                      ...
                      <td style="width:130px;background:#D84A38;">
                        <div>
                          ...
                          <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:33px;v-text-anchor:middle;width:130px;" stroke="f" fillcolor="#D84A38">
                            ...
                            <center>
                          <![endif]-->
                              <a href="http://gitasoft.id/gitasmartschooluniversity/persentasigitaschool.html"style="background-color:#D84A38;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:33px;text-align:center;text-decoration:none;width:130px;-webkit-text-size-adjust:none;">
                              lihat di sini !</a>
                          <!--[if mso]>
                            </center>
                          </v:rect>
                ...
                <td class="mobile-hide" style="padding-top:20px;padding-bottom:0;vertical-align:bottom">
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      ...
                      <img  style="display:block" src="http://gitasoft.id/gitasmartschooluniversity/img/SC1.png"  width="174" height="294" alt="iphone"/>
                      </td>
                    </tr>
                  </table>
                </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="w320" style="height:100%;">
              <tr>
                <td valign="top" class="mobile-padding" style="padding:20px;">
                  <h2>Dapatkan informasi lebih lanjut!</h2>
                  <br>
                  mengenai Gita Smart School dengan klik (link donwload proposal kami).<br>
                  <br>
                  <br>
                   <a href="http://gitasoft.id/gitasmartschooluniversity/file/ProposalGSS.pdf"style="background-color:#D84A38;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:33px;text-align:center;text-decoration:none;width:130px;-webkit-text-size-adjust:none;">
                              lihat di sini !</a>
                </td>
              </tr>
            </table>
