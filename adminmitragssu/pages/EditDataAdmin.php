...
<body>
    ...
    <div id="page-wrapper">
        ...
        <div class="container" style="width: 800px;">
          <form enctype="multipart/form-data" action="ProsesEditAdmin.php" method="post"> 
          ...
          <div class="form-group">
              ...
              <input type="text" name="email" class="form-control" value="<?php echo $d['email']?>" id="" placeholder="Email">
          </div>
          <div class="form-group">
              <label for="">Password</label>
              <input type="text" name="password" class="form-control" id="" value="<?php echo $d['password']?>" placeholder="Password">
          </div>
